                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <Link to="/forgot-password" className="text-xs text-orphan-blue hover:underline">
                            Forgot password?
                          </Link>
                        </div>
                        <div className="relative">
                          ...
                          >
                            {showPassword ? (
                              <EyeOff className="h-5 w-5 text-muted-foreground hover:text-gray-700" />
                            ) : (
                              <Eye className="h-5 w-5 text-muted-foreground hover:text-gray-700" />
                            )}
                          </button>
                        </div>
                      </div>
